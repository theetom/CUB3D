...
/*   Updated: 2025/05/21 22:32:49 by toferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	double	strafe_x = -data->plane_x;
	double	strafe_y = -data->plane_y;

	if (0 < (data->pos_x + strafe_x * data->move_speed * data->speed) &&
		data->map->max_x > (data->pos_x + strafe_x * data->move_speed * data->speed))
	{
		if (data->world_map[(int)(data->pos_y)]
	...
	if (0 < (data->pos_y + strafe_y * data->move_speed * data->speed) &&
		data->map->max_y > (data->pos_y + strafe_y * data->move_speed * data->speed))
	{
		if (data->world_map[(int)(data->pos_y + strafe_y * data->move_speed * data->speed)]
			[(int)(data->pos_x)] == 0)
...
static void	ft_rotate_right(t_data *data)
{
	double	old_dir_x;
	double	old_plane_x;
...
static void	ft_rotate_left(t_data *data)
{
	double	old_dir_x;
	double	old_plane_x;
