...
/*   Updated: 2025/05/22 16:17:42 by toferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_left(t_data *data)
{
	...
	* data->move_speed * data->speed))
	{
		if (data->world_map[(int)(data->pos_y)][(int)(data->pos_x + strafe_x \
		* data->move_speed * data->speed)] == 0)
	...
	* data->move_speed * data->speed))
	{
		if (data->world_map[(int)(data->pos_y + strafe_y * data->move_speed \
...
void	ft_move_right(t_data *data)
{
	...
	* data->move_speed * data->speed))
	...
	if (0 < (data->pos_y + strafe_y * data->move_speed \
	* data->speed) && data->map->max_y > (data->pos_y \
	+ strafe_y * data->move_speed * data->speed))
	{
		if (data->world_map[(int)(data->pos_y + strafe_y \
		* data->move_speed * data->speed)][(int)(data->pos_x)] == 0)
			data->pos_y += strafe_y * data->move_speed * data->speed;
	}
}
